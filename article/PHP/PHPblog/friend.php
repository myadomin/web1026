...
if($_GET['action'] == 'add'){
	...
	{
		//如果没有添加 那就添加好友信息 到数据库
		mysql_query("INSERT INTO tg_friend (tg_touser,tg_fromuser,tg_content,tg_date)
...
<div id="message">
	...
	<form method="post" action="friend.php?action=add">
		...
		<dl>
			...
			<dd><textarea name="content">我非常想和你做朋友，呵呵</textarea></dd>
			<dd>
				验 证 码：<input type="text" name="code" class="text yzm"  /> 
				<img src="code.php" id="code" /> 
				<input type="submit" class="submit" value="加好友" />
			</dd>
		</dl>
	</form>
</div>
