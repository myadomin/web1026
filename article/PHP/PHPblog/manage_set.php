...
if (!!$_rows = _fetch_array("
	...
	//文章
	if ($_html['article'] == 10) {
		$_html['article_html'] = '<select name="article"><option value="10" selected="selected">每页10篇</option><option value="6">每页6篇</option></select>';
	} elseif ($_html['article'] == 6) {
		$_html['article_html'] = '<select name="article"><option value="10">每页10篇</option><option value="6" selected="selected">每页6篇</option></select>';
	}
	
	//博友
	if ($_html['blog'] == 15) {
		$_html['blog_html'] = '<select name="blog"><option value="15" selected="selected">每页15人</option><option value="10">每页10人</option></select>';
	} elseif ($_html['blog'] == 10) {
		$_html['blog_html'] = '<select name="blog"><option value="15">每页15人</option><option value="10" selected="selected">每页10人</option></select>';
	}
