...
window.onload = function(){
	...
	//调用主模块1(main.js) './js/main.js'是main.js针对sea.js文件的相对路径，必须用./ 不能用../
	//未使用grunt.js之前 引用main.js 然后main.js引用drag.js','scale.js','range.js 这3个模块文件
...
//第三部分：sea.js常用的7个API总结 -----------------------------------
//请参考 https://github.com/seajs/seajs/issues/266
